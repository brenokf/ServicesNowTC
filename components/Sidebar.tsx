...
const Sidebar: React.FC<SidebarProps> = ({ user, currentModule, onNavigate, isMobileOpen, onCloseMobile }) => {
  ...
  const menuItems = [
    ...
    { id: 'projects', label: 'Projetos', icon: 'M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10' },
    { id: 'notebooks', label: 'Cadernos', icon: 'M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253' },
    { id: 'profiles', label: 'Profiles', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z' },
    { id: 'devices', label: 'Dispositivos', icon: 'M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z' },
    { id: 'tests', label: 'Testes', icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z' },
  ];
  ...
  const sidebarClasses = `
    fixed inset-y-0 left-0 z-50 w-72 bg-[#0e0e0e] text-white transition-all duration-500 ease-in-out lg:static lg:translate-x-0
        ...
        <div className="flex flex-col h-full">
          <div className="flex items-center px-10 h-24">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-indigo-600 rounded-2xl flex items-center justify-center font-black text-white shadow-xl shadow-indigo-600/30 text-lg">
                
              </div>
              <span className="text-2xl font-black tracking-tightest">STB</span>
            </div>
          </div>
              ...
              <button
                ...
                className={`w-full flex items-center gap-4 px-5 py-3.5 rounded-3xl text-sm font-bold transition-all ${
                  currentModule === item.id 
                    ? 'bg-[#e1251a] text-white shadow-2xl shadow-indigo-600/20 translate-x-1' 
                    : 'text-slate-400 hover:text-white hover:bg-[#4a5568]/50'
                }`}
              >
